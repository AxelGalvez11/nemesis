...
// dep — the same zero-dep posture as AppDrawer; reanimated is reserved for gestures).
...
/** A Card-shaped skeleton: mirrors ui.tsx <Card> (border, radius.md, surface) with a few text bars. */
