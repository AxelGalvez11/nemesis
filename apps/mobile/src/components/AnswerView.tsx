...
const styles = StyleSheet.create({
  ...
  bottomLine: { fontSize: type.small.fontSize + 1, lineHeight: 24, color: c.text, fontWeight: "500" },
  ...
  citeMeta: { fontSize: type.micro.fontSize, color: c.text3 },
  reportBtn: { paddingVertical: space(2.5), alignSelf: "flex-start" },
  reportText: { fontSize: type.micro.fontSize, color: c.text3, fontWeight: "600" },
  reportDone: { fontSize: type.micro.fontSize, color: c.good, fontWeight: "600", paddingVertical: space(2.5) },
  reportErr: { fontSize: type.micro.fontSize, color: c.danger, fontWeight: "600", paddingVertical: space(2.5) },
});
