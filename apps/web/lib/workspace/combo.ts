// Keybind combo display helpers — trimmed port of desktop src/lib/keybinds/combo.ts
// (display half only: the web foundation needs comboTokens/formatCombo for kbd
// hints; the capture/runtime half stays desktop-only).
