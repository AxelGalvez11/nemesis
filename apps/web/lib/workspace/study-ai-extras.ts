  ...
  return [
    { content: AUTOTAG_SYSTEM, role: "system" },
    {
      content:
        ...
        // mechanism" with medical examples, which told the model what field it was working in
        // before it had read a single card. A law student's deck came back tagged against a
        // taxonomy that does not exist in law. Structure generalises; a category list never does.
