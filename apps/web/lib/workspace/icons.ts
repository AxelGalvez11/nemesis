// Tabler icon re-exports under the desktop's lucide-era names — ported from
// desktop src/lib/icons.ts so transplanted markup keeps its exact identifiers.
import {
 ...
 * Use `<Icon className={iconSize.sm} />`; compose with `cn()` for extras.
 */
