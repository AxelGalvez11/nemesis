...
export function decisionOrReply(raw: string): TurnDecision | null {
  ...
  if (looksLikeEnvelope(prose)) {
    ...
    return salvaged
      ...
      ? { milestones: [], needsWeb: false, question: null, say: salvaged, then: "reply", topic: null, visuals: [], webFreshness: null, webQuery: null, webResults: null }
      : null;
  }
  ...
  return { milestones: [], needsWeb: false, question: null, say: prose, then: "reply", topic: null, visuals: [], webFreshness: null, webQuery: null, webResults: null };
}
