...
export function fail(reason: VerificationFailure, detail: string): Verification {
...
// The two EXPRESSION checks (a formula gives its stated value; two formulas agree across a
// range) live in expression-verification.ts. They need mathjs, and this module is reached by
// the canvas parser on the client, where mathjs must never be in the bundle.
