...
export async function askQuestion(question: string, mode?: AskMode): Promise<AskResponse> {
  if (isPreviewMode) {
    ...
    return {
      ...
      plain_english_summary: `Interpreting "${question}" as a white-flakes / dandruff question. White flakes are usually dandruff (mild seborrheic dermatitis) — but a few other things cause them too, and here's how to tell them apart.`,
      evidence_grade: "moderate",
      answer_sections: {
        // A consumer DIFFERENTIAL: several likely causes (with a range of meter strengths) — the shape the
        // gated CONSUMER_DIFFERENTIAL generation produces on a live consumer question.
        what_we_know: [
          { text: "**Dandruff (seborrheic dermatitis)** is the most common cause — white or yellowish flakes with an oily, sometimes itchy scalp, linked to the normal **Malassezia** yeast that lives on skin.", citation_ids: ["[1]", "[3]"] },
          { text: "**Dry scalp** makes smaller, dry flakes and a tight-feeling scalp, often after harsh shampoo, over-washing, or cold weather.", citation_ids: ["[1]"] },
          { text: "**Product buildup** from gels, dry shampoo, or heavy oils can flake off and look like dandruff — usually without much itch or redness.", citation_ids: ["[1]"] },
          { text: "**Scalp psoriasis** causes thicker, silvery scale on well-defined patches, often at the hairline, and tends to be more stubborn than dandruff.", citation_ids: ["[2]"] },
          { text: "For mild cases, guidance describes **anti-dandruff shampoos** with ketoconazole, selenium sulfide, or zinc pyrithione as a common first step.", citation_ids: ["[3]"] },
        ],
        what_we_do_not_know: [
          { text: "This local preview does not query the live corpus, so it should not be used as medical guidance.", citation_ids: [] },
        ],
        safety_notes: [
          { text: "See a clinician if you have bleeding, pus, painful or spreading patches, hair loss, or no improvement after a few weeks of a medicated shampoo.", citation_ids: ["[2]"] },
        ],
        questions_to_ask: [],
        // The honest "other side": a complication the sources raise.
        what_contradicts: [
          { text: "One review notes flakes alone **can't reliably separate** dandruff from early scalp psoriasis without examining the scalp.", citation_ids: ["[2]"] },
        ],
      },
      citations: [
        {
          chunk_tag: "[1]",
          source_id: "source-preview-medlineplus",
          source_type: "medlineplus",
          title: "Dandruff, Cradle Cap, and Other Scalp Conditions (MedlinePlus)",
          section: "overview",
          ...
          evidence_weight: 60,
          support_reason: "Consumer-health guidance describing the common causes.",
        },
        {
          chunk_tag: "[2]",
          source_id: "source-preview-trial",
          source_type: "pubmed",
          title: "Distinguishing scalp psoriasis from seborrheic dermatitis: a controlled study",
          section: "diagnosis",
          ...
          evidence_weight: 72,
          support_reason: "Clinical study distinguishing the two conditions.",
        },
        {
          chunk_tag: "[3]",
          source_id: "source-preview-systematic",
          source_type: "pubmed",
          title: "Topical antifungals for seborrheic dermatitis: a systematic review",
          section: "results",
          url: "https://pubmed.ncbi.nlm.nih.gov/",
          license: "abstract",
          ...
          evidence_weight: 90,
          support_reason: "Systematic review of first-line treatment.",
        },
      ],
      safety_flags: [],
