...
export async function askQuestion(question: string, mode?: AskMode): Promise<AskResponse> {
  if (isPreviewMode) {
    ...
    return {
      ...
      plain_english_summary: `Sucralose is probably fine in normal amounts — it's approved and hasn't been shown to be harmful at typical intakes — but it's not a health food, and a couple of the scarier claims about it don't really hold up.`,
      evidence_grade: "moderate",
      answer_sections: {
        // A claim-check ("is X bad?"): plain-English points addressing the specific worries, each cited,
        // with a range of strengths — the shape the gated claim-check generation produces on a live claim.
        what_we_know: [
          { text: "On the **cancer** worry: major regulators haven't found a credible link — the FDA assessed 110+ studies and European regulators reaffirmed no safety concern at normal intake.", citation_ids: ["[1]"] },
          { text: "For **weight and blood sugar**, health authorities advise against relying on sweeteners like sucralose for long-term weight control.", citation_ids: ["[2]"] },
          { text: "A recent trial did find sucralose can shift **gut bacteria** and cause more digestive upset in some people — though what that means for health is still unclear.", citation_ids: ["[3]"] },
        ],
        what_we_do_not_know: [
          { text: "Long-term effects at high intake, and use during pregnancy, remain uncertain.", citation_ids: [] },
        ],
        safety_notes: [],
        questions_to_ask: [],
        // The honest "other side".
        what_contradicts: [
          { text: "On the other hand, that same trial found sweetener products **didn't worsen** metabolic markers and slightly helped weight maintenance — cutting against the idea that it's simply harmful.", citation_ids: ["[3]"] },
        ],
      },
      citations: [
        {
          chunk_tag: "[1]",
          source_id: "source-preview-fda",
          source_type: "openfda",
          title: "FDA sucralose safety assessment (summary)",
          section: "safety",
          url: "https://www.accessdata.fda.gov/",
          license: "public-domain",
          ...
          evidence_weight: 88,
          support_reason: "Regulatory safety assessment.",
        },
        {
          chunk_tag: "[2]",
          source_id: "source-preview-systematic",
          source_type: "pubmed",
          title: "Non-sugar sweeteners for long-term weight control: a systematic review",
          section: "conclusions",
          ...
          evidence_weight: 90,
          support_reason: "Systematic review of weight-control evidence.",
        },
        {
          chunk_tag: "[3]",
          source_id: "source-preview-trial",
          source_type: "pubmed",
          title: "Sucralose, the gut microbiome, and cardiometabolic markers: a randomized trial",
          section: "results",
          url: "https://pubmed.ncbi.nlm.nih.gov/",
          license: "abstract",
          ...
          evidence_weight: 74,
          support_reason: "Randomized trial on microbiome + metabolic markers.",
        },
      ],
      safety_flags: [],
