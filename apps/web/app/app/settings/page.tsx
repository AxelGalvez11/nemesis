    ...
    <div style={{ maxWidth: 720, margin: "0 auto", display: "grid", gap: 16 }}>
      ...
      <section className="card">
        ...
        <div className="row" style={{ marginBottom: 12 }}>
          ...
          <Link className="button-link" href="/app/billing">{plan?.plan === "plus" ? "Manage plan" : "Upgrade"}</Link>
        </div>
        <div className="action-row">
          <Link className="button-link secondary" href="/app/profile" style={{ background: "var(--surface)", border: "1px solid var(--line)", color: "var(--text-2)" }}>Profile & data</Link>
