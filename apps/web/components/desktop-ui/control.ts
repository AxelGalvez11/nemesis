...
export const controlVariants = cva(
  "desktop-input-chrome w-full min-w-0 rounded-lg border text-xs leading-4 text-foreground outline-none placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      size: {
