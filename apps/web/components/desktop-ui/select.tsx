...
import { type ControlVariantProps, controlVariants } from "@/components/desktop-ui/control";
...
function SelectContent({
  ...
  return (
    <SelectPrimitive.Portal>
      {/* data-workspace: portaled under document.body, outside the shell wrapper —
          the attribute re-scopes the desktop token layer onto this subtree. */}
