...
import { Loader2, Search } from "@/lib/workspace/icons";
...
interface SearchFieldProps {
  ...
  /** Data-driven placeholder suggestions — one picked at random per mount. */
  hints?: string[];
 ...
 * No box — borderless until focus, then an underline. Rests at low opacity
 * until focused or filled. Width/placement come from `containerClassName`.
 */
