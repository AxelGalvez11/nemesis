...
const SHAPE_NOTE: Record<ShapeId, string> = {
  ...
  square: "A rounded square. The bible-strong reference's cube, flattened.",
  capsule: "Straight sides, fully round ends, taller than wide.",
  cylinder: "Straight sides with flatter ends than a capsule.",
  diamond: "A square stood on its corner.",
