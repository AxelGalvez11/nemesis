...
export function DocsSource({ source, notesFromSource, onOpenPath, onRevealFolder, onOpenHome }: DocsSourceProps) {
  ...
  return (
    <div className="mx-auto flex min-h-full w-full max-w-3xl min-w-0 flex-col px-8 pb-16 pt-6 max-sm:px-4">
      <header>
        <DocsCrumbs onOpenHome={onOpenHome} onRevealFolder={onRevealFolder} path={source.folderPath} />
