...
export function DocsSource({ source, notesFromSource, onOpenPath, onOpenFolder, onOpenHome }: DocsSourceProps) {
  ...
  return (
    <div className="mx-auto flex min-h-full w-full max-w-3xl min-w-0 flex-col px-8 pb-16 pt-6 max-sm:px-4">
      <header>
        <DocsCrumbs onOpenFolder={onOpenFolder} onOpenHome={onOpenHome} path={source.folderPath} />
