...
export function PdfPageView({
  ...
  useEffect(() => {
    ...
    if (canvasRef.current) canvasRef.current.dataset.painted = "false";
    ...
    void (async () => {
      ...
      // 🔴 STAMPED ON THE ELEMENT AS WELL AS THE REF, because the crop moved out of this file: the
      // reader's comment layer cuts from this canvas, and it can only see the DOM. Same invariant,
      // one more reader of it — an unrendered canvas is not empty, it is 300x150 of nothing.
