...
const USER_BUBBLE_READ_CLASS =
  "cursor-pointer text-[length:var(--conversation-text-font-size)] leading-(--dt-line-height) text-foreground/95 transition-colors border-(--ui-stroke-tertiary) hover:border-(--ui-stroke-secondary)";
  ...
  return (
    ...
    >
      {editing ? (
        ...
        <>
          <div
            className={cn(USER_BUBBLE_BASE_CLASS, USER_BUBBLE_READ_CLASS, "text-center", !expanded && "sticky-human-clamp")}
