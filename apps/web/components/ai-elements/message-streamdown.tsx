...
// The Streamdown half of MessageResponse. Installed from the AI Elements message registry, then
// intentionally reduced to the one primitive this workspace uses. Keeping MessageResponse preserves
...
// The public `MessageResponse` (message.tsx) loads this file on demand, so streamdown, its
// three plugins and shiki stay out of every page's entry script until a message actually draws.
