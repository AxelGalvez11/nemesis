...
export const metadata: Metadata = { title: "Nemesis · E · Together" };

/**
 * Variation E. Sana Learn's page, section for section, carrying our story: the student and their
 * agents working on the same material.
 *
 * WHAT IS REAL. FSRS scheduling, .pptx slides, .docx guides, seventeen input formats and the
 * canvas all exist in the app today. Outside agents connecting (Claude, ChatGPT, Cursor) is not
 * built; the owner chose on 2026-09-10 to show it by name, as a promise for launch.
 *
 * 🔴 NO TESTIMONIALS. Sana's page runs quotes from named customers. Nemesis has none to quote, and a
 * made-up quote with a made-up name is a fake review, so the sections that carry quotes there carry
 * product here.
 */
...
// Names only, in one serif: see Marquee.tsx for why there are no crests and no "trusted by".
const SCHOOLS = [
  "Harvard University",
  "Stanford University",
  "MIT",
...
export default function VariantTogether() {
  ...
  return (
    <div className="sn">
      ...
      <main>
        ...
        <Marquee label="Bring your course from any school" items={SCHOOLS} />
