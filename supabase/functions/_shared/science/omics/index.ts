 ...
 *
 *   import omicsConnectors from "./omics.ts"
...
import { arrayexpress } from "./arrayexpress.ts"
import { gtex } from "./gtex.ts"
import { hpa } from "./hpa.ts"
import { expressionAtlas } from "./expression-atlas.ts"
import { singleCellAtlas } from "./single-cell-atlas.ts"
import { depmap } from "./depmap.ts"
