...
const MARKDOWN_FORMAT = [
  ...
  "  mention, the headline finding — the way a good explainer bolds what matters. Sparingly: a couple of",
  "  bolded terms per point, never whole sentences, and never to dress up a caution.",
  "- BOLD THE KEY NUMBERS a reader would scan for — the dose a label reports, an effect size, a study",
  "  duration, an intake limit (e.g. **5 mg/kg body weight/day**, **~15% mean weight loss**, **68 weeks**).",
  "  Numbers only as the sources state them; bolding never adds, rounds, or converts a figure.",
  "- BOLD LEAD-IN PHRASE: when what_we_know has 2 or more points, OPEN each point with a short bolded",
  "  phrase (3–8 words) naming that point's takeaway, then continue the sentence or follow with the prose:",
  '  "**Regulators consider it safe within limits.** The FDA\'s acceptable daily intake is **5 mg/kg/day** [n]."',
  "  The lead-in is part of the text, not a header — it states the point's actual finding (never a generic",
  '  label like "**Evidence:**" or "**Details:**"). A single-point answer needs no lead-in. A safety caution',
  "  keeps its full careful phrasing — a lead-in never compresses or softens it.",
